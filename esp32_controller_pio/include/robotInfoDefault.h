...
const servoStruct s_rl2 =   {588, 1490, 2372, true};    // RIGHT LEG FEMUR
const servoStruct s_rl3 =   {643, 1550, 2432, true};    // RIGHT LEG TIBIA
...
const servoStruct s_ll2 =   {685, 1580, 2470, true};    // LEFT LEG FEMUR
const servoStruct s_ll3 =   {567, 1522, 2437, true};    // LEFT LEG TIBIA
